...
public class Activity_201_Kalinkovichi_Mozyr extends AppCompatActivity implements interfaceGetArrayListArray {
    ...
    private static String tableWeekday = DataBaseHelper.TABLE_201_KALINKOVICHI_MOZYR_WEEKDAY;
    private static String tableDayOff = DataBaseHelper.TABLE_201_KALINKOVICHI_MOZYR_DAYOFF;
    private static String nameActivity = DataBaseHelper.ROUTE_201_KALINKOVICHI_MOZYR;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textToolbar.setText(R.string._201_Kalnkvch_Mozyr);
