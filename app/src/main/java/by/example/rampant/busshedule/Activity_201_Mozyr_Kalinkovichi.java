...
public class Activity_201_Mozyr_Kalinkovichi extends AppCompatActivity implements interfaceGetArrayListArray {
    ...
    private static String tableWeekday = DataBaseHelper.TABLE_201_MOZYR_KALINKOVICHI_WEEKDAY;
    private static String tableDayOff = DataBaseHelper.TABLE_201_MOZYR_KALINKOVICHI_DAYOFF;
    private static String nameActivity = DataBaseHelper.ROUTE_201_MOZYR_KALINKOVICHI;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textToolbar.setText(R.string._201_Mozyr_Kalnkvch);
